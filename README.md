...
```javascript
import minabs from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-minabs@v0.2.4-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-minabs/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/math-base-special-minabs/actions/workflows/test.yml?query=branch:v0.2.4
